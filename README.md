...
You can use this site as the origin for an edge app just by cloning the [starter app](https://github.com/fastly/hello-compute) and following the instructions inside it.
...
Now you can clone the [starter app](https://github.com/fastly/hello-compute) repo.
